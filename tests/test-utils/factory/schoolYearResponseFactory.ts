import { SchoolYearResponse } from "@api-server";
...
class SchoolYearResponseFactory extends Factory<SchoolYearResponse, SchoolYearResponseTransientParams> {
...
export const schoolYearResponseFactory = SchoolYearResponseFactory.define(({ sequence, transientParams }) => {
