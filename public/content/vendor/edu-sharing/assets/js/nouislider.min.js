...
!(function (a) {
    ...
    function H(a, b) {
        ...
        if (0 !== b && ((a.margin = a.spectrum.getMargin(b)), !a.margin))
            throw new Error(
                'noUiSlider (' + U + "): 'margin' option is only supported on linear sliders.",
            );
    }
    function I(a, b) {
    ...
    function J(a, b) {
        ...
        if (0 !== b) {
            if (((a.padding = a.spectrum.getMargin(b)), !a.padding))
                throw new Error(
                    'noUiSlider (' + U + "): 'padding' option is only supported on linear sliders.",
                );
            if (a.padding < 0)
                throw new Error(
            ...
            if (a.padding >= 50)
                throw new Error(
                    'noUiSlider (' + U + "): 'padding' option must be less than half the range.",
                );
        }
    }
    function K(a, b) {
    ...
    function L(a, b) {
        if ('string' != typeof b)
            throw new Error(
                'noUiSlider (' + U + "): 'behaviour' must be a string containing options.",
            );
        ...
        if (e) {
            if (2 !== a.handles)
                throw new Error(
                    'noUiSlider (' + U + "): 'fixed' behaviour must be used with 2 handles",
                );
