...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs */ 76309);
...
class WorkspaceExplorerComponent {
  ...
  load(event = null) {
    ...
    if (this.searchQuery$.value) {
      ...
      this.load$.next({
        reset: event?.reset,
        nodes: this.search.search(criterias, [], request, this.connector.getCurrentLogin() && this.connector.getCurrentLogin().isAdmin ? _core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestConstants.CONTENT_TYPE_ALL : _core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestConstants.CONTENT_TYPE_FILES_AND_FOLDERS, _core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestConstants.HOME_REPOSITORY, _core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestConstants.DEFAULT, [], 'workspace')
      });
  ...
  constructor(connector, translate, storage, temporaryStorage, config, search, toast, ui, nodeApi, localEvents) {
    ...
    this.searchQuery$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__.BehaviorSubject(null);
    this.node$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__.BehaviorSubject(null);
    this.load$ = new rxjs__WEBPACK_IMPORTED_MODULE_8__.ReplaySubject();
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.combineLatest)([this.node$, this.searchQuery$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.distinctUntilChanged)((a, b) => {
      return _core_module_rest_helper__WEBPACK_IMPORTED_MODULE_2__.Helper.objectEquals(a[0], b[0]) && a[1] === b[1];
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.debounceTime)(10)).subscribe( /*#__PURE__*/function () {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.tap)(({
      ...
      this.dataSource.isLoading = true;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)( /*#__PURE__*/function () {
      var _ref2 = (0,_home_bergatco_Repositories_ITs_JOINTLY_edu_sharing_community_repository_Frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
        ...
        return yield nodes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.catchError)(err => {
  ...
  registerNodesDeleted() {
    this.localEvents.nodesDeleted.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.takeUntil)(this.destroyed)).subscribe(nodes => {
  ...
  static #_ = this.ɵfac = function WorkspaceExplorerComponent_Factory(t) {
    return new (t || WorkspaceExplorerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestConnectorService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_18__.TranslateService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.SessionStorageService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](ngx_edu_sharing_ui__WEBPACK_IMPORTED_MODULE_6__.TemporaryStorageService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.ConfigurationService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestSearchService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_services_toast__WEBPACK_IMPORTED_MODULE_4__.Toast), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.UIService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_core_module_core_module__WEBPACK_IMPORTED_MODULE_1__.RestNodeService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](ngx_edu_sharing_ui__WEBPACK_IMPORTED_MODULE_6__.LocalEventsService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_19__.NgIf, ngx_edu_sharing_ui__WEBPACK_IMPORTED_MODULE_6__.NodeEntriesWrapperComponent, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_18__.TranslatePipe],
