cordova.define(
    'cordova-plugin-android-permissions.Permissions',
    function (require, exports, module) {
        ...
        function deprecated(name) {
            ...
            console.warn(
                "The new signature is '" + name + "(permission, successCallback, errorCallback)'",
            );
        }

        Permissions.prototype = {
            checkPermission: function (permission, successCallback, errorCallback) {
                cordova.exec(successCallback, errorCallback, permissionsName, 'checkPermission', [
                    permission,
                ]);
            },
            requestPermission: function (permission, successCallback, errorCallback) {
                ...
                cordova.exec(successCallback, errorCallback, permissionsName, 'requestPermission', [
                    permission,
                ]);
            },
