	...
	<div>
		<nav class="navbar header has-shadow is-primary" role="navigation" aria-label="main navigation">
			<div class="navbar-brand">
				...
				<nuxt-link v-if="!authenticated" class="navbar-item" to="/login">Login</nuxt-link>

				<span v-if="authenticated" class="navbar-item">Hallo, {{ firstName }}</span>
			...
			<aside class="column is-2 section">
				...
				<ul class="menu-list">
					<li v-for="(item, key) of items" :key="key">
						<nuxt-link :to="item.to" exact-active-class="is-active">{{ item.title }}</nuxt-link>
					</li>
				</ul>
			</aside>
		...
		<footer class="footer">
			<div class="content has-text-centered">
				<div class="is-flex align-items-center justify-content-center">
					<img style="height: 35px" src="/images/footer-logo.png" alt="Anbieterlogo">
				...
				<div class="mt-2">
					...
					<span>-</span>
					<a href="/impressum#data_security" target="_blank">Datenschutzerklärung</a>
					<span>-</span>
					<a href="mailto:hpi-info@hpi.de?subject=Schul_Cloud%20Anfrage" target="_blank">Kontakt</a>
					<span>-</span>
				...
				<div class="mt-2">
					<p class="made-with-love">Made with
