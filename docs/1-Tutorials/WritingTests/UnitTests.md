...
Für die Häufigsten Tests gibt es ebenfalls Hilfsfunktionen. Zu finden unter [`/tests/unit/commonTests.js`](https://github.com/hpi-schul-cloud/nuxt-client/blob/develop/tests/unit/commonTests.js)
