export default {
	...
	"components.molecules.move.card.question": "¿A dónde se debe mover la tarjeta?",
	"components.molecules.move.card.label.room": "Seleccionar sala",
	"components.molecules.move.card.label.board": "Seleccionar tablero",
	"components.molecules.move.card.label.section": "Seleccionar sección",
