export default {
	...
	"common.validation.tooLong": "El texto introducido supera la longitud máxima de {maxLength}.",
	"common.validation.tooShort": "El texto introducido es inferior a la longitud mínima de {minLength}.",
