export default {
	...
	"pages.lernstore.info.banner.item.0.brb":
		"З цього моменту медіатеки з Lernstore (Mundo, Wir lernen online та FWU-Medien) доступні через медіаполицю, а вміст можна інтегрувати в розділи як інструмент. Додаткову інформацію про розширені можливості пошуку та фільтрації, а також інтеграцію вмісту через глибокі посилання можна знайти на {helpLinkText}.",
