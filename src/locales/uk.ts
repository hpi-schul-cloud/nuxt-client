export default {
	...
	"components.atoms.VCustomChipTimeRemaining.hintMinutes": "хвилина | хвилини (хвилин)",
	...
	"components.molecules.move.card.question": "Куди слід перемістити картку?",
	"components.molecules.move.card.label.room": "Оберіть кімнату",
	"components.molecules.move.card.label.board": "Оберіть дошку",
	"components.molecules.move.card.label.section": "Оберіть розділ",
