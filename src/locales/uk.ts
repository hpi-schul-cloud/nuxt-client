export default {
	...
	"pages.room.dialog.boardType.title": "Виберіть вид",
	"pages.room.dialog.boardType.singleColumn": "одноколонкові",
	"pages.room.dialog.boardType.multiColumn": "багатоколонкові",
