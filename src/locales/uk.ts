export default {
	...
	"common.validation.tooLong": "Введений текст перевищує максимальну довжину {maxLength}.",
	"common.validation.tooShort": "Введений текст не досягає мінімальної довжини {minLength}.",
