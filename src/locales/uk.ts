export default {
	...
	"pages.courseRoom.headerSection.synchronized": "Синхронізовано",
	"pages.courseRoom.headerSection.toCourseFiles": "До файлів курсу",
	"pages.courseRoom.index.courses.active": "Поточні курси",
