export default {
	...
	"common.validation.tooLong": "The text you entered exceeds the maximum length of {maxLength}.`",
	"common.validation.tooShort": "The text you entered is below the minimum length of {minLength}.",
