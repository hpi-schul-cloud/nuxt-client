export default {
	...
	"pages.rooms.members.registrations.remove.confirmation": "Remove invitation for {invitedEmail} from the room?",
	"pages.rooms.members.registrations.multipleRemove.confirmation": "Remove selected invitations from the room?",
