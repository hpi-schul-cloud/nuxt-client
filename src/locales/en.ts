export default {
	...
	"pages.room.dialog.boardType.title": "Select view",
	"pages.room.dialog.boardType.singleColumn": "single-column",
	"pages.room.dialog.boardType.multiColumn": "multi-column",
