export default {
	...
	"components.molecules.move.card.label.room": "Select room",
	"components.molecules.move.card.label.board": "Select board",
	"components.molecules.move.card.label.section": "Select section",
