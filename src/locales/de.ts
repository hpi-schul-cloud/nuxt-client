export default {
	...
	"components.molecules.copyInfo.title": "Wichtige Kopier-Informationen",
	"components.molecules.copyInfo.text.nextStep": "Im nächsten Schritt wird eine Kopie des {type}s erstellt.",
	"components.molecules.copyInfo.text.alert.followingContent": "Folgendes wird nicht kopiert:",
	"components.molecules.copyInfo.text.alert.membersPermissions": "Kurs-Mitglieder und Berechtigungen",
	"components.molecules.copyInfo.text.alert.courseFiles": "Dateien unter Kursdateien",
	"components.molecules.copyInfo.text.alert.courseGroup": "Kursgruppen",
	"components.molecules.copyInfo.text.alert.Etherpad": "Inhalte aus Etherpads",
	"components.molecules.copyInfo.text.alert.whiteboard": "Inhalte aus Whiteboards",
	"components.molecules.copyInfo.text.alert.geogebra": "Geogebra IDs",
	"components.molecules.copyInfo.text.alert.protectedSettings": "Geschützte Einstellungen externer Tools",
