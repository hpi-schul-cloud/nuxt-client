export default {
	...
	"components.molecules.move.card.question": "Wohin soll die Karte verschoben werden?",
	"components.molecules.move.card.label.room": "Raum wählen",
	"components.molecules.move.card.label.board": "Bereich wählen",
	"components.molecules.move.card.label.section": "Abschnitt wählen",
