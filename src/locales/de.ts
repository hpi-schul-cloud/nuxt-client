export default {
	...
	"common.validation.tooLong": "Der eingegebene Text überschreitet die Maximallänge von {maxLength}.",
	"common.validation.tooShort": "Der eingegebene Text unterschreitet die Mindestlänge von {minLength}.",
