...
export const defaultConfigEnvs: ConfigResponse = {
	...
	FEATURE_ROOM_ADD_STUDENTS_ENABLED: false,
	FEATURE_ROOMS_DUPLICATION_ENABLED: false,
	FEATURE_ROOM_MEMBERS_TABS_ENABLED: false,
	FEATURE_ROOM_INVITATION_LINKS_ENABLED: false,
