...
export const BoardColumnApiFactory = function (
	...
	return {
		...
		columnControllerCreateCard(
			...
			return localVarFp
				.columnControllerCreateCard(columnId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
 ...
 * @export
 */
export const ColumnsApiAxiosParamCreator = function (
	configuration?: Configuration
) {
	return {
		/**
 ...
 * @export
 */
export const ColumnsApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) {
...
export class ColumnsApi extends BaseAPI implements ColumnsApiInterface {
	 ...
	 */
	public columnControllerCreateCard(columnId: string, options?: any) {
		return ColumnsApiFp(this.configuration)
			.columnControllerCreateCard(columnId, options)
			.then((request) => request(this.axios, this.basePath));
	}
 ...
 * @export
 */
export const ElementsApiAxiosParamCreator = function (
	configuration?: Configuration
) {
	return {
		/**
 ...
 * @export
 */
export const ElementsApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) {
...
export class ElementsApi extends BaseAPI implements ElementsApiInterface {
	...
	public elementControllerDeleteElement(
		...
		return ElementsApiFp(this.configuration)
			.elementControllerDeleteElement(contentElementId, options)
			.then((request) => request(this.axios, this.basePath));
	}
