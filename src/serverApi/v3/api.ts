...
export const AccountApiAxiosParamCreator = function (
	...
	return {
		 ...
		 */
		accountControllerChangePassword: async (
			id: string,
			...
			const localVarPath = `/account/{id}/pw`.replace(
				`{${"id"}}`,
...
export const AccountApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async accountControllerChangePassword(
			id: string,
			changePasswordParams: ChangePasswordParams,
			options?: any
		): Promise<
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.accountControllerChangePassword(
					id,
					changePasswordParams,
					options
				);
...
export const AccountApiFactory = function (
	...
	return {
		...
		accountControllerChangePassword(
			...
			return localVarFp
				.accountControllerChangePassword(id, changePasswordParams, options)
...
export class AccountApi extends BaseAPI implements AccountApiInterface {
	 ...
	 * @memberof AccountApi
	 */
	public accountControllerChangePassword(
		id: string,
		changePasswordParams: ChangePasswordParams,
		options?: any
	) {
...
export const DashboardApiAxiosParamCreator = function (
	...
	return {
		...
		dashboardControllerMoveElement: async (
			...
			const localVarPath = `/dashboard/{id}/moveElement`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		dashboardControllerPatchGroup: async (
			...
			const localVarPath = `/dashboard/{id}/element`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DashboardApiFactory = function (
	...
	return {
		...
		dashboardControllerMoveElement(
			...
			return localVarFp
				.dashboardControllerMoveElement(id, moveElementParams, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		dashboardControllerPatchGroup(
			...
			return localVarFp
				.dashboardControllerPatchGroup(id, x, y, patchGroupParams, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export const NewsApiAxiosParamCreator = function (
	...
	return {
		...
		newsControllerDelete: async (
			...
			const localVarPath = `/news/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const NewsApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.newsControllerDelete(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.newsControllerFindOne(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
...
export const NewsApiFactory = function (
	...
	return {
		...
		newsControllerDelete(id: string, options?: any): AxiosPromise<string> {
			return localVarFp
				.newsControllerDelete(id, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Responds with all news for a user.
		...
		newsControllerFindOne(
			...
			return localVarFp
				.newsControllerFindOne(id, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Update properties of a news.
		...
		newsControllerUpdate(
			...
			return localVarFp
				.newsControllerUpdate(id, updateNewsParams, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Responds with news of a given team for a user.
...
export const TaskApiAxiosParamCreator = function (
	...
	return {
		...
		taskControllerFinish: async (
			...
			const localVarPath = `/tasks/{id}/finish`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		taskControllerRestore: async (
			...
			const localVarPath = `/tasks/{id}/restore`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TaskApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.taskControllerDelete(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.taskControllerFinish(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.taskControllerRestore(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
...
export const TaskApiFactory = function (
	...
	return {
		...
		taskControllerDelete(id: string, options?: any): AxiosPromise<boolean> {
			return localVarFp
				.taskControllerDelete(id, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		taskControllerFinish(
			...
			return localVarFp
				.taskControllerFinish(id, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		taskControllerRestore(
			...
			return localVarFp
				.taskControllerRestore(id, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export const UserImportApiAxiosParamCreator = function (
	...
	return {
		...
		importUserControllerRemoveMatch: async (
			...
			const localVarPath = `/user/import/{id}/match`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		importUserControllerUpdateFlag: async (
			...
			const localVarPath = `/user/import/{id}/flag`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UserImportApiFactory = function (
	...
	return {
		...
		importUserControllerRemoveMatch(
			...
			return localVarFp
				.importUserControllerRemoveMatch(id, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		importUserControllerSetMatch(
			...
			return localVarFp
				.importUserControllerSetMatch(id, updateMatchParams, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		importUserControllerStartSchoolInUserMigration(
			...
			return localVarFp
				.importUserControllerStartSchoolInUserMigration(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		importUserControllerUpdateFlag(
			...
			return localVarFp
				.importUserControllerUpdateFlag(id, updateFlagParams, options)
				.then((request) => request(axios, basePath));
		},
	};
};
