...
export const CardsApiAxiosParamCreator = function (
	...
	return {
		...
		taskCardControllerCreate: async (
			createTaskCardParams: CreateTaskCardParams,
			options: any = {}
		): Promise<RequestArgs> => {
		...
		taskCardControllerUpdate: async (
			id: string,
			updateTaskCardParams: UpdateTaskCardParams,
			options: any = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'id' is not null or undefined
...
export const CardsApiFactory = function (
	...
	return {
		...
		taskCardControllerCreate(
			...
			return localVarFp
				.taskCardControllerCreate(createTaskCardParams, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		taskCardControllerUpdate(
			...
			return localVarFp
				.taskCardControllerUpdate(id, updateTaskCardParams, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export const RoomsApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.roomsControllerCopyCourse(roomId, {
					...options,
					timeout: 3000,
				});
			return createRequestFunction(
