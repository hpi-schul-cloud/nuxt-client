...
export const AuthenticationApiAxiosParamCreator = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		loginControllerLoginOauth: async (
			code?: string,
			error?: string,
			redirect?: string,
			options: any = {}
...
export const AuthenticationApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async loginControllerLoginOauth(
			code?: string,
			error?: string,
			redirect?: string,
			options?: any
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.loginControllerLoginOauth(
					code,
					error,
					redirect,
					options
...
export const AuthenticationApiFactory = function (
	...
	return {
		...
		loginControllerLoginOauth(
			...
			return localVarFp
				.loginControllerLoginOauth(code, error, redirect, options)
				.then((request) => request(axios, basePath));
		},
	};
};
	...
	implements AuthenticationApiInterface
{
	 ...
	 * @memberof AuthenticationApi
	 */
	public loginControllerLoginOauth(
		code?: string,
		error?: string,
		redirect?: string,
		options?: any
...
export const BoardsApiAxiosParamCreator = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		boardControllerCreateCard: async (
			boardId: string,
			columnId: string,
			options: any = {}
		): Promise<RequestArgs> => {
...
export const BoardsApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.boardControllerCreateBoard(options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		 ...
		 * @throws {RequiredError}
		 */
		async boardControllerCreateCard(
			boardId: string,
			columnId: string,
			options?: any
		): Promise<
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.boardControllerCreateCard(
					boardId,
					columnId,
					options
				);
...
export const BoardsApiFactory = function (
	...
	return {
		...
		boardControllerCreateBoard(options?: any): AxiosPromise<BoardResponse> {
			return localVarFp
				.boardControllerCreateBoard(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		 ...
		 * @throws {RequiredError}
		 */
		boardControllerCreateCard(
			boardId: string,
			columnId: string,
			options?: any
		): AxiosPromise<CardResponse> {
			return localVarFp
				.boardControllerCreateCard(boardId, columnId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class BoardsApi extends BaseAPI implements BoardsApiInterface {
	 ...
	 * @memberof BoardsApi
	 */
	public boardControllerCreateCard(
		boardId: string,
		columnId: string,
		options?: any
	) {
	...
	return {
		...
		async cardControllerCreateElement(
			...
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<TextElementResponse>
		> {
			const localVarAxiosArgs =
...
export const CardsApiFactory = function (
	...
	return {
		...
		cardControllerCreateElement(
			...
			return localVarFp
				.cardControllerCreateElement(cardId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const DashboardApiFactory = function (
	...
	return {
		...
		dashboardControllerFindForUser(
			...
			return localVarFp
				.dashboardControllerFindForUser(showSubstitute, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class DashboardApi extends BaseAPI implements DashboardApiInterface {
	 ...
	 */
	public dashboardControllerFindForUser(
		showSubstitute?: boolean,
		options?: any
	) {
...
export const SSOApiAxiosParamCreator = function (
	...
	return {
		...
		oauthSSOControllerMigrateUser: async (
			...
			const localVarPath = `/sso/oauth/{systemId}/migration`.replace(
				`{${"systemId"}}`,
...
export const SSOApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.oauthSSOControllerMigrateUser(
					systemId,
					options
				);
			return createRequestFunction(
...
export const SSOApiFactory = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		oauthSSOControllerMigrateUser(
			systemId: string,
			options?: any
		): AxiosPromise<void> {
			return localVarFp
				.oauthSSOControllerMigrateUser(systemId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const ToolApiAxiosParamCreator = function (
	...
	return {
		...
		toolControllerCreateExternalTool: async (
			externalToolPostParams: ExternalToolPostParams,
			options: any = {}
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		toolControllerGetLti11LaunchParameters: async (
			toolId: string,
			courseId: string,
			options: any = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'toolId' is not null or undefined
			assertParamExists(
				"toolControllerGetLti11LaunchParameters",
				"toolId",
				toolId
			);
			// verify required parameter 'courseId' is not null or undefined
			...
			const localVarPath = `/tools/lti11/{toolId}/launch`.replace(
				`{${"toolId"}}`,
				encodeURIComponent(String(toolId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ToolApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async toolControllerGetLti11LaunchParameters(
			toolId: string,
			courseId: string,
			options?: any
		): Promise<
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<Lti11LaunchResponse>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.toolControllerGetLti11LaunchParameters(
					toolId,
					courseId,
					options
				);
...
export const ToolApiFactory = function (
	...
	return {
		...
		toolControllerCreateExternalTool(
			...
			return localVarFp
				.toolControllerCreateExternalTool(externalToolPostParams, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		toolControllerGetLti11LaunchParameters(
			...
			return localVarFp
				.toolControllerGetLti11LaunchParameters(toolId, courseId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class ToolApi extends BaseAPI implements ToolApiInterface {
	...
	public toolConfigurationControllerGetAvailableToolsForSchool(
		...
		return ToolApiFp(this.configuration)
			.toolConfigurationControllerGetAvailableToolsForSchool(scope, id, options)
			.then((request) => request(this.axios, this.basePath));
	}
	 ...
	 * @memberof ToolApi
	 */
	public toolControllerGetLti11LaunchParameters(
		toolId: string,
		courseId: string,
		options?: any
	) {
	...
	public toolControllerUpdateExternalTool(
		...
		return ToolApiFp(this.configuration)
			.toolControllerUpdateExternalTool(toolId, externalToolPostParams, options)
			.then((request) => request(this.axios, this.basePath));
	}
