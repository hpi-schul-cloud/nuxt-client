...
export const GroupApiAxiosParamCreator = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		groupControllerFindClassesForSchool: async (
			skip?: number,
			limit?: number,
			sortOrder?: "asc" | "desc",
...
export const GroupApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.groupControllerFindClassesForSchool(
					skip,
					limit,
					sortOrder,
					sortBy,
...
export class GroupApi extends BaseAPI implements GroupApiInterface {
	 ...
	 * @memberof GroupApi
	 */
	public groupControllerFindClassesForSchool(
		skip?: number,
		limit?: number,
		sortOrder?: "asc" | "desc",
		sortBy?: "name" | "externalSourceName",
...
export const SchoolApiAxiosParamCreator = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		legacySchoolControllerGetMigration: async (
			schoolId: string,
			options: any = {}
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		legacySchoolControllerSetMigration: async (
			schoolId: string,
...
export const SchoolApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async legacySchoolControllerGetMigration(
			schoolId: string,
			options?: any
		): Promise<
			(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.legacySchoolControllerGetMigration(
					schoolId,
					options
				);
			return createRequestFunction(
		 ...
		 * @throws {RequiredError}
		 */
		async legacySchoolControllerSetMigration(
			schoolId: string,
			migrationBody: MigrationBody,
			options?: any
		): Promise<
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.legacySchoolControllerSetMigration(
					schoolId,
					migrationBody,
					options
				);
...
export const SchoolApiFactory = function (
	...
	return {
		...
		legacySchoolControllerGetMigration(
			...
			return localVarFp
				.legacySchoolControllerGetMigration(schoolId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		legacySchoolControllerSetMigration(
			...
			return localVarFp
				.legacySchoolControllerSetMigration(schoolId, migrationBody, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SchoolApi extends BaseAPI implements SchoolApiInterface {
	 ...
	 * @memberof SchoolApi
	 */
	public legacySchoolControllerSetMigration(
		schoolId: string,
		migrationBody: MigrationBody,
		options?: any
	) {
...
export const ToolApiAxiosParamCreator = function (
	...
	return {
		...
		toolControllerGetToolReferences: async (
			...
			const localVarPath =
				`/tools/external-tools/{contextType}/{contextId}/references`
					.replace(`{${"contextId"}}`, encodeURIComponent(String(contextId)))
					.replace(
						`{${"contextType"}}`,
						encodeURIComponent(String(contextType))
