...
export interface TaskCardResponse {
    ...
    dueDate: string;
    /**
     * List of users who marked task card as completed
     * @type {Array<string>}
     * @memberof TaskCardResponse
     */
...
export const CardsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        taskCardControllerCompleteForUser: async (id: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('taskCardControllerCompleteForUser', 'id', id)
            const localVarPath = `/cards/task/{id}/complete`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        taskCardControllerUndoCompletionForUser: async (id: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('taskCardControllerUndoCompletionForUser', 'id', id)
            const localVarPath = `/cards/task/{id}/undoCompletion`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const CardsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async taskCardControllerCompleteForUser(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskCardResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskCardControllerCompleteForUser(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async taskCardControllerUndoCompletionForUser(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskCardResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskCardControllerUndoCompletionForUser(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const CardsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        taskCardControllerCompleteForUser(id: string, options?: any): AxiosPromise<TaskCardResponse> {
            return localVarFp.taskCardControllerCompleteForUser(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {TaskCardParams} taskCardParams 
         ...
         * @throws {RequiredError}
         */
        taskCardControllerUndoCompletionForUser(id: string, options?: any): AxiosPromise<TaskCardResponse> {
            return localVarFp.taskCardControllerUndoCompletionForUser(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id The id of the task card.
...
export class CardsApi extends BaseAPI implements CardsApiInterface {
     ...
     * @memberof CardsApi
     */
    public taskCardControllerCompleteForUser(id: string, options?: any) {
        return CardsApiFp(this.configuration).taskCardControllerCompleteForUser(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardsApi
     */
    public taskCardControllerUndoCompletionForUser(id: string, options?: any) {
        return CardsApiFp(this.configuration).taskCardControllerUndoCompletionForUser(id, options).then((request) => request(this.axios, this.basePath));
    }
