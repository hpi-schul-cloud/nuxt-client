...
export enum CopyApiResponseTypeEnum {
	...
	Leaf = "LEAF",
	LearnstoreElement = "LEARNSTORE_ELEMENT",
	Lesson = "LESSON",
 ...
 *
 * @export
 * @interface LearnstoreContentBody
 */
export interface LearnstoreContentBody {
	/**
	 *
	 * @type {string}
	 * @memberof LearnstoreContentBody
	 */
	someId?: string;
}
 ...
 *
 * @export
 * @interface LearnstoreElementContent
 */
export interface LearnstoreElementContent {
	/**
	 *
	 * @type {string}
	 * @memberof LearnstoreElementContent
	 */
	someId: string | null;
}
 ...
 *
 * @export
 * @interface LearnstoreElementContentBody
 */
export interface LearnstoreElementContentBody {
	/**
	 *
	 * @type {ContentElementType}
	 * @memberof LearnstoreElementContentBody
	 */
	type: ContentElementType;
	/**
	 *
	 * @type {LearnstoreContentBody}
	 * @memberof LearnstoreElementContentBody
	 */
 ...
 *
 * @export
 * @interface LearnstoreElementResponse
 */
export interface LearnstoreElementResponse {
	/**
	 *
	 * @type {string}
	 * @memberof LearnstoreElementResponse
	 */
	id: string;
	/**
	 *
...
export interface UpdateElementContentBodyParams {
	/**
	 *
	 * @type {FileElementContentBody | LinkElementContentBody | RichTextElementContentBody | SubmissionContainerElementContentBody | ExternalToolElementContentBody | DrawingElementContentBody | LearnstoreElementContentBody }
...
export class GroupApi extends BaseAPI implements GroupApiInterface {
	...
	public groupControllerFindClasses(
		...
		return GroupApiFp(this.configuration)
			.groupControllerFindClasses(skip, limit, sortOrder, sortBy, type, options)
			.then((request) => request(this.axios, this.basePath));
	}
