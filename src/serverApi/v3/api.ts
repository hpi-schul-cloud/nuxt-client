...
export const BoardCardApiAxiosParamCreator = function (
	...
	return {
		...
		cardControllerCreateElement: async (
			cardId: string,
			createContentElementBody: CreateContentElementBody,
			options: any = {}
		): Promise<RequestArgs> => {
	...
	return {
		...
		async cardControllerCreateElement(
			...
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<TextElementResponse | FileElementResponse>
		> {
			const localVarAxiosArgs =
...
export const BoardCardApiFactory = function (
	...
	return {
		...
		cardControllerCreateElement(
			...
			return localVarFp
				.cardControllerCreateElement(cardId, createContentElementBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const BoardElementApiAxiosParamCreator = function (
	...
	return {
		...
		elementControllerUpdateElement: async (
			contentElementId: string,
			elementContentUpdateBodyParams: ElementContentUpdateBodyParams,
			options: any = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'contentElementId' is not null or undefined
			assertParamExists(
