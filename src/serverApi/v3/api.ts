...
export const CoursesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        courseControllerGetCourseForTeacher: async (courseId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'courseId' is not null or undefined
            assertParamExists('courseControllerGetCourseForTeacher', 'courseId', courseId)
...
export const CoursesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async courseControllerGetCourseForTeacher(courseId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CourseResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.courseControllerGetCourseForTeacher(courseId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CoursesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        courseControllerGetCourseForTeacher(courseId: string, options?: any): AxiosPromise<CourseResponse> {
            return localVarFp.courseControllerGetCourseForTeacher(courseId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CoursesApi extends BaseAPI implements CoursesApiInterface {
     ...
     * @memberof CoursesApi
     */
    public courseControllerGetCourseForTeacher(courseId: string, options?: any) {
        return CoursesApiFp(this.configuration).courseControllerGetCourseForTeacher(courseId, options).then((request) => request(this.axios, this.basePath));
    }
}
