...
import { AUTH_MODULE_KEY, injectStrict, STATUS_ALERTS_MODULE_KEY } from "@/utils/inject";
...
const statusAlerts: ComputedRef<StatusAlert[]> = computed(() => statusAlertsModule.getStatusAlerts);
...
const roleNames = computed(() => authModule.getUserRoles);
