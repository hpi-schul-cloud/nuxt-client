		...
		describe("when the roomId is defined", () => {
			...
			describe("when the API call fails", () => {
				it("should show a failure message", async () => {
					...
					expect(mockedBoardNotifierCalls.showFailure).toHaveBeenCalledWith("pages.rooms.invitationlinks.error.load");
				});
			});
		});
	...
	describe("createLink", () => {
		...
		describe("when the API call fails", () => {
			it("should show a failure message", async () => {
				...
				expect(mockedBoardNotifierCalls.showFailure).toHaveBeenCalledWith("pages.rooms.invitationlinks.error.create");
	...
	describe("updateLink", () => {
		...
		describe("when the API call fails", () => {
			it("should show a failure message", async () => {
				...
				expect(mockedBoardNotifierCalls.showFailure).toHaveBeenCalledWith("pages.rooms.invitationlinks.error.update");
				expect(roomInvitationLinkStore.invitationStep).not.toStrictEqual(InvitationStep.SHARE);
			});
		});
	});
	...
	describe("deleteLink", () => {
		...
		describe("when the API call fails", () => {
			it("should show a failure message", async () => {
				...
				expect(mockedBoardNotifierCalls.showFailure).toHaveBeenCalledWith("pages.rooms.invitationlinks.error.delete");
			});
		});
	});
