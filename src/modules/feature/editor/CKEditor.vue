...
import { default as CKEditorVue } from "@ckeditor/ckeditor5-vue";
...
type ToolbarMode = "simple" | "regular" | "news";
type ToolbarType = "classic" | "balloon";
type Editor =
	| typeof CustomCKEditor.ClassicEditor
	| typeof CustomCKEditor.BalloonEditor;
...
const props = defineProps({
	...
	mode: {
		type: String as PropType<ToolbarMode>,
		default: "regular",
	},
	disabled: {
		type: Boolean,
...
const handleReady = (editor: Editor) => {
	...
	editor.editing.view.document.on(
		"keydown",
		(evt: Event, data: { domEvent: KeyboardEvent }) => {
