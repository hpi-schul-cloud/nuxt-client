...
describe("logger", () => {
	...
	it("should log info messages with optionalParams", () => {
		...
		expect(console.log).toHaveBeenCalledWith(expect.stringContaining("[INFO]"), message, ...optionalParams);
	});
	...
	it("should log warn messages with optionalParams", () => {
		...
		expect(console.warn).toHaveBeenCalledWith(expect.stringContaining("[WARN]"), message, ...optionalParams);
	});
	...
	it("should log error messages with optionalParams", () => {
		...
		expect(console.error).toHaveBeenCalledWith(expect.stringContaining("[ERROR]"), message, ...optionalParams);
	});
	...
	it("should log messages with log method and optionalParams", () => {
		...
		expect(console.log).toHaveBeenCalledWith(expect.stringContaining("[LOG]"), message, ...optionalParams);
	});
