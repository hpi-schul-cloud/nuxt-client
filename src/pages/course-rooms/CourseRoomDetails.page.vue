...
export default defineComponent({
	...
	computed: {
		...
		learnContentFabItems() {
			...
			if (this.authModule.getUserPermissions.includes("HOMEWORK_CREATE".toLowerCase())) {
				actions.push({
			...
			if (this.authModule.getUserPermissions.includes("TOPIC_CREATE".toLowerCase())) {
				actions.push({
		...
		canEditTools() {
			return !!this.authModule?.getUserPermissions.includes("CONTEXT_TOOL_ADMIN".toLowerCase());
		},
		headlineMenuItems() {
