...
const spyMocks = {
	storeRoomAlignMock: vi.spyOn(courseRoomListModule, "align").mockImplementation(async () => ({})),
	storeModuleFetchMock: vi.spyOn(courseRoomListModule, "fetch").mockImplementation(async () => ({})),
	storeModuleFetchAllMock: vi.spyOn(courseRoomListModule, "fetchAllElements").mockImplementation(async () => ({})),
	storeModuleUpdateMock: vi.spyOn(courseRoomListModule, "update").mockImplementation(async () => ({})),
};
