...
import { authModule, commonCartridgeImportModule, courseRoomListModule } from "@/store";
...
const isLoading: ComputedRef<boolean> = computed(() => courseRoomListModule.getLoading);
