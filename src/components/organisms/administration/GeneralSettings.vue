...
import { LanguageType, SchoolFeature, SchoolUpdateBodyParams } from "@/serverApi/v3";
...
const hasSchoolEditPermission = computed(() => authModule.getUserPermissions.includes("school_edit"));
