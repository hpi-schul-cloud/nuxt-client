	...
	methods: {
		getItemTitle(item) {
			const titles = {
				...
				LEARN_MATERIAL: this.$t(
					"components.molecules.copyResult.label.learnMaterial"
				),
				LEARN_MATERIAL_GROUP: this.$t(
					"components.molecules.copyResult.label.learnMaterialGroup"
				),
