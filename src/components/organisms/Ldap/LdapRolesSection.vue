<template>
	<div>
		...
		<div role="group" class="section-sub-header">
			...
			>
				<v-radio :label="$t('pages.administration.ldapEdit.roles.labels.radio.ldapGroup')" value="group" />
				<v-radio :label="$t('pages.administration.ldapEdit.roles.labels.radio.userAttribute')" value="user_attribute" />
			</v-radio-group>
