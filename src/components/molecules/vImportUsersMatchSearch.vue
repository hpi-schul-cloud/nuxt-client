<template>
	<v-card>
		<v-toolbar dark color="primary">
			<v-toolbar-title
				>Merge <strong>WebSchule</strong> account of {{ editedItem.firstName }}
				{{ editedItem.lastName }} with:</v-toolbar-title
			>
			<v-spacer></v-spacer>
			<v-toolbar-items>
		...
		<v-card-text>
			Search from <strong>{{ this.$theme.short_name }}</strong>
			<base-link
				target="_blank"
				:href="
