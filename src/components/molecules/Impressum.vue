<template>
	<div class="impressum-container">
		...
		<p
			...
			<br />
			Email:
			<a href="mailto:info@schul-cloud.org" target="_blank" class="externalLink"
				>info@schul-cloud.org<base-icon source="material" icon="launch"
			/></a>
			<br />
			Internet:
			<a href="https://schul-cloud.org" taregt="blank"
				>https://schul-cloud.org</a
			><br />
		...
		<h3 class="header">Vertretungsberechtigter Geschäftsführer:</h3>
		<p
		...
		<h3 class="header">Redaktion:</h3>
		<p>Hasso Plattner Institut</p>
		<h3 class="header">Rechtliche Hinweise</h3>
		<p
			>Die HPI Schul-Cloud ist ein nicht kommerzielles Pilotprojekt, welches vom
			HPI in Kooperation mit dem nationalen Excellence-Schulnetzwerk MINT EC (<a
				href="https://www.mint-ec.de"
				taregt="blank"
				>https://www.mint-ec.de<base-icon source="material" icon="launch"/></a
			...
			(BMBF) gefördert wird (mehr Informationen finden Sie unter: (<a
				...
				taregt="blank"
				>https://hpi.de/schul-cloud<base-icon
					source="material"
					icon="launch"/></a
			>).</p
		>
