...
describe("SchoolPolicyFormDialog", () => {
	...
	describe("when form is not valid", () => {
		...
		it("should focus input field when it is the first invalid input", async () => {
			const { wrapper } = setup();
			const fileInput = wrapper.findComponent(VFileInput);
	...
	describe("file input validation", () => {
		...
		it("should show error message when file is not a PDF", async () => {
			...
			expect(fileInput.text()).toContain("pages.administration.school.index.schoolPolicy.validation.notPdf");
		});
		...
		it("should show error message when file exceeds size limit", async () => {
			...
			expect(fileInput.text()).toContain("pages.administration.school.index.schoolPolicy.validation.fileTooBig");
		});
	});
