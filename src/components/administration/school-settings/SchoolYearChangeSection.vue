...
const startTransfer = async () => {
	const isConfirmed = await askConfirmation({
		...
		message: "components.administration.schoolYearChangeSection.dialog.start.content",
		messageType: "info",
	});
...
const finishTransfer = async () => {
	const isConfirmed = await askConfirmation({
		title: "components.administration.schoolYearChangeSection.dialog.finish.title",
