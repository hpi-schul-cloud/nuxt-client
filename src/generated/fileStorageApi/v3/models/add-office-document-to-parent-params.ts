...
import { OfficeDocumentType } from './office-document-type';

/**
 * 
 * @export
 * @interface AddOfficeDocumentToParentParams
 */
export interface AddOfficeDocumentToParentParams {
    /**
     * 
     * @type {string}
     * @memberof AddOfficeDocumentToParentParams
     */
    fileName: string;
    /**
     * 
