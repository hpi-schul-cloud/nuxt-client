...
describe("TypeGuard", () => {
	...
	describe("isBoolean", () => {
		...
		describe("when passing type of value is NOT a boolean", () => {
			...
			it("should return false", () => {
				expect(TypeGuard.isBoolean(1)).toBe(false);
			});
		});
	});
	...
	describe("checkNumber", () => {
		...
		describe("when passing type of value is NOT a number", () => {
			it("should return false", () => {
				expect(() => TypeGuard.checkNumber(undefined)).toThrowError(
					"Type is not a number"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkNumber(null)).toThrowError(
					"Type is not a number"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkNumber({})).toThrowError(
					"Type is not a number"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkNumber("string")).toThrowError(
					"Type is not a number"
				);
			});
		});
	...
	describe("checkString", () => {
		...
		describe("when passing type of value is NOT a string", () => {
			it("should return false", () => {
				expect(() => TypeGuard.checkString(undefined)).toThrowError(
					"Type is not a string"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkString(null)).toThrowError(
					"Type is not a string"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkString({})).toThrowError(
					"Type is not a string"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkString(1)).toThrowError(
					"Type is not a string"
				);
			});
		});
	...
	describe("isStringOfValues", () => {
		describe("when value is in values", () => {
			...
			it("should return true", () => {
				expect(TypeGuard.isStringOfStrings("string", ["string", ""])).toBe(
					true
				);
			});
		});
	...
	describe("checkStringOfValues", () => {
		...
		describe("when value is NOT in values", () => {
			...
			it("should throw an error", () => {
				...
				expect(() =>
					TypeGuard.checkStringOfStrings(undefined, ["string"])
				).toThrowError(error);
			});
			...
			it("should throw an error", () => {
				...
				expect(() =>
					TypeGuard.checkStringOfStrings(null, ["string"])
				).toThrowError(error);
			});
			...
			it("should throw an error", () => {
				...
				expect(() =>
					TypeGuard.checkStringOfStrings({}, ["string"])
				).toThrowError(error);
			});
			...
			it("should throw an error", () => {
				const error = buildError();
				expect(() =>
					TypeGuard.checkStringOfStrings(1, ["string"])
				).toThrowError(error);
			});
	...
	describe("checkArray", () => {
		...
		describe("when passing type of value is NOT an array", () => {
			it("should throw an error", () => {
				expect(() => TypeGuard.checkArray(undefined)).toThrowError(
					"Type is not an array."
				);
			});

			it("should throw an error", () => {
				expect(() => TypeGuard.checkArray(null)).toThrowError(
					"Type is not an array."
				);
			});

			it("should throw an error", () => {
				expect(() => TypeGuard.checkArray({})).toThrowError(
					"Type is not an array."
				);
			});

			it("should throw an error", () => {
				expect(() => TypeGuard.checkArray(1)).toThrowError(
					"Type is not an array."
				);
			});
		});
	...
	describe("checkArrayWithElements", () => {
		...
		describe("when passing type of value is NOT an array", () => {
			it("should throw an error", () => {
				expect(() => TypeGuard.checkArrayWithElements([])).toThrowError(
					"Type is not an array with elements."
				);
			});

			it("should throw an error", () => {
				expect(() => TypeGuard.checkArrayWithElements(undefined)).toThrowError(
					"Type is not an array with elements."
				);
			});

			it("should throw an error", () => {
				expect(() => TypeGuard.checkArrayWithElements(null)).toThrowError(
					"Type is not an array with elements."
				);
			});
			...
			it("should throw an error", () => {
				expect(() => TypeGuard.checkArrayWithElements(1)).toThrowError(
					"Type is not an array with elements."
				);
			});
		});
	...
	describe("checkDefinedObject", () => {
		describe("when passing type of value is an object", () => {
			...
			it("should be return value", () => {
				expect(TypeGuard.checkDefinedObject({ a: { b: 1 } })).toEqual({
					a: { b: 1 },
				});
			});
		});
		...
		describe("when passing type of value is NOT an object", () => {
			it("should return false", () => {
				expect(() => TypeGuard.checkDefinedObject(undefined)).toThrowError(
					"Type is not an object"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkDefinedObject(null)).toThrowError(
					"Type is not an object"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkDefinedObject([])).toThrowError(
					"Type is not an object"
				);
			});

			it("should return false", () => {
				expect(() => TypeGuard.checkDefinedObject("string")).toThrowError(
					"Type is not an object"
				);
			});
		});
	...
	describe("getValueFromObjectKey", () => {
		describe("when passing value is an object that has the requested key", () => {
			it("should be return the key value", () => {
				expect(TypeGuard.getValueFromObjectKey({ xyz: "abc" }, "xyz")).toEqual(
					"abc"
				);
			});
		});
		...
		describe("when passing value and key do not match", () => {
			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromObjectKey({ xyz: "abc" }, "zzz")
				).toBeUndefined();
			});
			...
			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromObjectKey("string", "zzz")
				).toBeUndefined();
			});
			...
			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromObjectKey(undefined, "zzz")
				).toBeUndefined();
			});
		});
		...
		describe("when param contract is not fullfilled", () => {
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromObjectKey({ xyz: "abc" }, undefined)
				).toThrowError("Type is not a string");
			});

			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromObjectKey({ xyz: "abc" }, null)
				).toThrowError("Type is not a string");
			});
			...
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromObjectKey({ xyz: "abc" }, 1)
				).toThrowError("Type is not a string");
			});
		});
	});
	...
	describe("getValueFromDeepObjectKey", () => {
		describe("when passing value is an object that has the requested key path", () => {
			it("should be return the key value", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey({ x1: { x2: "abc" } }, [
						"x1",
						"x2",
					])
				).toEqual("abc");
		...
		describe("when passing value and key path do not match", () => {
			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey({ xyz: "abc" }, ["x1", "x2"])
				).toBeUndefined();
			});

			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey({ x1: { zzz: "abc" } }, [
						"x1",
						"x2",
					])
				).toBeUndefined();
			...
			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey([], ["x1", "x2"])
				).toBeUndefined();
			});

			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey("string", ["x1", "x2"])
				).toBeUndefined();
			});

			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey(1, ["x1", "x2"])
				).toBeUndefined();
			});

			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey(null, ["x1", "x2"])
				).toBeUndefined();
			});

			it("should be return undefined", () => {
				expect(
					TypeGuard.getValueFromDeepObjectKey(undefined, ["x1", "x2"])
				).toBeUndefined();
			});
		});
		...
		describe("when param contract is not fullfilled", () => {
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromDeepObjectKey({ x1: { x2: "abc" } }, undefined)
				).toThrowError("Type is not an array with elements.");
			});

			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromDeepObjectKey({ x1: { x2: "abc" } }, null)
				).toThrowError("Type is not an array with elements.");
			});
			...
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.getValueFromDeepObjectKey({ x1: { x2: "abc" } }, 1)
				).toThrowError("Type is not an array with elements.");
			});
		});
	});
	...
	describe("isEachKeyInObject", () => {
		describe("when passing value is an object that has all requested keys", () => {
			it("should return true", () => {
				expect(
					TypeGuard.isEachKeyInObject({ x1: "abc", x2: "bcd" }, ["x1", "x2"])
				).toBe(true);
			});

			it("should return true", () => {
				expect(
					TypeGuard.isEachKeyInObject({ x1: "abc", x2: "bcd" }, ["x1"])
				).toBe(true);
			});
		});
		...
		describe("when passing params do not match", () => {
			it("should return false", () => {
				expect(
					TypeGuard.isEachKeyInObject({ x1: "abc", x2: "bcd" }, [
						"x1",
						"x2",
						"x3",
					])
			...
			it("should return false", () => {
				expect(
					TypeGuard.isEachKeyInObject(
						{ x1: "abc", x2: "bcd" },
						"x1" as unknown as string[]
					)
				).toBe(false);
			});
			...
			it("should return false", () => {
				expect(TypeGuard.isEachKeyInObject(undefined, ["x1", "x2"])).toBe(
					false
				);
			});
	...
	describe("checkKeyInObject", () => {
		...
		describe("when passing value and key do not match", () => {
			it("should be throw an error", () => {
				expect(() =>
					TypeGuard.checkKeyInObject({ xyz: "abc" }, "zzz")
				).toThrowError("Object has no zzz.");
			});

			it("should be throw an error", () => {
				expect(() => TypeGuard.checkKeyInObject([], "zzz")).toThrowError(
					"Type is not an object."
				);
			});

			it("should be throw an error", () => {
				expect(() => TypeGuard.checkKeyInObject("string", "zzz")).toThrowError(
					"Type is not an object."
				);
			});

			it("should be throw an error", () => {
				expect(() => TypeGuard.checkKeyInObject(1, "zzz")).toThrowError(
					"Type is not an object."
				);
			});

			it("should be throw an error", () => {
				expect(() => TypeGuard.checkKeyInObject(null, "zzz")).toThrowError(
					"Type is not an object."
				);
			});

			it("should be throw an error", () => {
				expect(() => TypeGuard.checkKeyInObject(undefined, "zzz")).toThrowError(
					"Type is not an object."
				);
			});
		});
		...
		describe("when param contract is not fullfilled", () => {
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.checkKeyInObject({ xyz: "abc" }, undefined)
				).toThrowError("Type is not a string");
			});
			...
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.checkKeyInObject({ xyz: "abc" }, null)
				).toThrowError("Type is not a string");
			});
			...
			it("should be throw an error", () => {
				expect(() =>
					//@ts-expect-error Test case not possible with typescript
					TypeGuard.checkKeyInObject({ xyz: "abc" }, 1)
				).toThrowError("Type is not a string");
			});
		});
	});
	...
	describe("checkKeysInInstance", () => {
		...
		describe("when passing value and keys do not match", () => {
			it("should throw an error", () => {
				...
				expect(() =>
					TypeGuard.checkKeysInInstance(example, ["email"])
				).toThrowError("Object lacks these properties: email.");
			});
	...
	describe("requireKeys", () => {
		...
		describe("when passing value and keys do not match", () => {
			it("should throw an error", () => {
				...
				expect(() => TypeGuard.requireKeys(example, ["email"])).toThrowError(
	...
	describe("checkNotNullOrUndefined", () => {
		describe("when value is null", () => {
			it("should throw error if it is passed", () => {
				expect(() =>
					TypeGuard.checkNotNullOrUndefined(null, new Error("Test"))
				).toThrow("Test");
			});

			it("should throw default error if not error passed", () => {
				expect(() => TypeGuard.checkNotNullOrUndefined(null)).toThrow(
					"Type is null."
				);
			});
		});
		...
		describe("when value is undefined", () => {
			it("should throw error if it is passed", () => {
				expect(() =>
					TypeGuard.checkNotNullOrUndefined(undefined, new Error("Test"))
				).toThrow("Test");
			});

			it("should throw default error if not error passed", () => {
				expect(() => TypeGuard.checkNotNullOrUndefined(undefined)).toThrow(
					"Type is undefined."
				);
			});
		});
