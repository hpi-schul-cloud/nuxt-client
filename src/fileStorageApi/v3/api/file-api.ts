...
export const FileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadPreview: async (fileRecordId: string, fileName: string, outputFormat?: 'image/webp', width?: 500, height?: 1000, forceUpdate?: boolean, range?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'fileRecordId' is not null or undefined
...
export const FileApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async downloadPreview(fileRecordId: string, fileName: string, outputFormat?: 'image/webp', width?: 500, height?: 1000, forceUpdate?: boolean, range?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
...
export const FileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        downloadPreview(fileRecordId: string, fileName: string, outputFormat?: 'image/webp', width?: 500, height?: 1000, forceUpdate?: boolean, range?: string, options?: any): AxiosPromise<object> {
...
export class FileApi extends BaseAPI implements FileApiInterface {
     ...
     * @memberof FileApi
     */
    public downloadPreview(fileRecordId: string, fileName: string, outputFormat?: 'image/webp', width?: 500, height?: 1000, forceUpdate?: boolean, range?: string, options?: any) {
