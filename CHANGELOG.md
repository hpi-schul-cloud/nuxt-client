...
- `controllableData`-mixin [#799](https://github.com/schul-cloud/nuxt-client/pull/799) as a helper for optionaly syncable props. Check [the docs for more detail](./docs/1-Tutorials/OptionalyPropControllableData.md).
