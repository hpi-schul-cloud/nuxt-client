cordova.define('cordova-plugin-nativestorage.mainHandle', function (require, exports, module) {
    ...
    function isInBrowser() {
        inBrowser =
            (window.cordova &&
                (window.cordova.platformId === 'browser' || window.cordova.platformId === 'osx')) ||
    ...
    StorageHandle.prototype.initWithSuiteName = function (suiteName, success, error) {
        ...
        this.storageHandlerDelegate(success, error, 'NativeStorage', 'initWithSuiteName', [
            suiteName,
        ]);
    };
                ...
                function (returnedBool) {
                    if ('string' === typeof returnedBool) {
                        if (returnedBool === 'true') {
                            ...
                            error(
                                'The returned boolean from SharedPreferences was not recognized: ' +
                                    returnedBool,
                            );
                        }
                    } else {
    ...
    StorageHandle.prototype.putDouble = function (reference, aFloat, success, error) {
        ...
        this.storageHandlerDelegate(success, error, 'NativeStorage', 'putDouble', [
            reference,
            aFloat,
        ]);
    };
