cordova.define('cordova-plugin-http.CordovaHttpPlugin', function (require, exports, module) {
    ...
    var http = {
        ...
        uploadFile: function (url, params, headers, filePath, name, success, failure) {
            headers = mergeHeaders(this.headers, headers);
            return exec(success, failure, 'CordovaHttpPlugin', 'uploadFile', [
                url,
                params,
                headers,
                filePath,
        ...
        downloadFile: function (url, params, headers, filePath, success, failure) {
            ...
            var win = function (result) {
                ...
                entry.filesystem = new FileSystem(
                    result.file.filesystemName ||
                        (result.file.filesystem == window.PERSISTENT ? 'persistent' : 'temporary'),
                );
                entry.nativeURL = result.file.nativeURL;
                success(entry);
            };
            return exec(win, failure, 'CordovaHttpPlugin', 'downloadFile', [
                url,
                params,
                headers,
                filePath,
        ...
        angular.module('cordovaHTTP', []).factory('cordovaHTTP', function ($timeout, $q) {
            ...
            var cordovaHTTP = {
                ...
                uploadFile: function (url, params, headers, filePath, name) {
                    return makePromise(
                        http.uploadFile,
                        [url, params, headers, filePath, name],
                        true,
                    );
                },
